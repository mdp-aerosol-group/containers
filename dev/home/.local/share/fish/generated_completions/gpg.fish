...
complete -c gpg -l personal-aead-preferences -d 'Set the list of personal AEAD preferences to string'
...
complete -c gpg -l aead-algo -d 'Specify that the AEAD algorithm name is to be used'
